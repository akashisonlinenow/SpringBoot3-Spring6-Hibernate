...
import com.akashonlinehere.cruddemo.entity.*;
...
public class CruddemoApplication {
	...
	private void addMoreCoursesForStudent(AppDAO appDAO) {
		int theId = 2;
		Student tempStudent = appDAO.findStudentAndCoursesNyStudentId(theId);
	...
	private void createCourseAndReviews(AppDAO appDAO) {
		...
		tempCourse.addReview(new Review("What a dumb course, u r an idiot"));
	...
	private void createInstructorWithCourses(AppDAO appDAO) {
		...
		// save the instructor
		// NOTE - this will also save the courses bcos of CascadeTpe.PERSIST
